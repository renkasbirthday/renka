...
export default function Blob() {
  ...
  return (
    ...
    <input ref={inputRef} className='menu-check' type="checkbox"></input>
    <div className="menu">
      <h2>MENU</h2>
      <div className="menu-blob">
    ...
    <div className="blob one">
      ...
      <circle cx='100' cy='100' r='80' fill='#b19cd7' />
        <g>
          <svg className="blobs" xmlns="http://www.w3.org/2000/svg">
            <path
              fill="#00796B66"
      ...
      <Link to='/' onClick={() => setKey(k => k + 1)}>Home</Link>
    </div>
    <div className="blob two">
      ...
      <circle cx='100' cy='100' r='80' fill='#b19cd7' />
        ...
        <Link to='/memory' onClick={() => setKey(k => k + 1)}>Our Memories Game</Link>
    </div>
    <div className="blob three">
      ...
      <Link to='/hangman' onClick={() => setKey(k => k + 1)}>Hangman Game</Link>
    </div>
    <div className="blob four">
      ...
      <Link to='/timeline' onClick={() => setKey(k => k + 1)}>Our Timeline</Link>
